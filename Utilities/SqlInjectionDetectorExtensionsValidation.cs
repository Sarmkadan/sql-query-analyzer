...
/// <summary>
/// Provides validation helpers for SqlInjectionDetectorExtensions method parameters.
/// Validates null values, empty strings, out-of-range numbers, and default dates.
/// </summary>
public static class SqlInjectionDetectorExtensionsValidation
{
    /// <summary>
    /// Validates parameters for <see cref="SqlInjectionDetectorExtensions.FilterBySeverity(SqlInjectionDetector, List{SqlInjectionIssue}, string)"/>
    /// extension method.
    /// </summary>
    ...
    /// <param name="minSeverity">Minimum severity level (must not be null or empty).</param>
        ...
        string? minSeverity = null)
    {
        ...
        // Validate issues list (required parameter)
        if (issues is null)
        {
    ...
    /// and <see cref="SqlInjectionDetectorExtensions.GenerateSummaryReport(SqlInjectionDetector, List{SqlInjectionIssue})\"/>
    /// extension methods.
    /// </summary>
    /// <param name="detector">The detector instance (can be null).</param>
    /// <param name="issues">List of detected vulnerabilities (must not be null).</param>
    ...
    /// <summary>
    /// Validates parameters for <see cref="SqlInjectionDetectorExtensions.GenerateDetailedReport(SqlInjectionDetector, List{SqlInjectionIssue}, string)"/>
    /// extension method.
    /// </summary>
    /// <param name="detector">The detector instance (can be null).</param>
    /// <param name="issues">List of detected vulnerabilities (must not be null).</param>
    ...
    /// <summary>
    /// Validates parameters for <see cref="SqlInjectionDetectorExtensions.HasCriticalIssues(SqlInjectionDetector, List{SqlInjectionIssue})\"/>
    /// extension method.
    /// </summary>
    /// <param name="detector">The detector instance (can be null).</param>
    /// <param name="issues">List of detected vulnerabilities (must not be null).</param>
    ...
    /// <summary>
    /// Determines whether the parameters for <see cref="SqlInjectionDetectorExtensions.FilterBySeverity(SqlInjectionDetector, List{SqlInjectionIssue}, string)"/>
    /// are valid.
    /// </summary>
    ...
    public static bool IsValid(
        ...
        string? minSeverity = null)
    {
        return Validate(detector, issues, minSeverity).Count == 0;
    }
    ...
    public static bool IsValidGroupByTypeAndGenerateSummaryReport(
        ...
        List<SqlInjectionIssue>? issues)
    {
        return ValidateGroupByTypeAndGenerateSummaryReport(detector, issues).Count == 0;
    }

    /// <summary>
    /// Determines whether the parameters for <see cref="SqlInjectionDetectorExtensions.GenerateDetailedReport(SqlInjectionDetector, List{SqlInjectionIssue}, string)"/>
    /// are valid.
    /// </summary>
    /// <param name="detector">The detector instance.</param>
    /// <param name="issues">List of detected vulnerabilities.</param>
    ...
    public static bool IsValidDetailedReport(
        ...
        string? query)
    {
        return ValidateDetailedReport(detector, issues, query).Count == 0;
    }

    /// <summary>
    /// Determines whether the parameters for <see cref="SqlInjectionDetectorExtensions.HasCriticalIssues(SqlInjectionDetector, List{SqlInjectionIssue})\"/>
    /// are valid.
    /// </summary>
    /// <param name="detector">The detector instance.</param>
    /// <param name="issues">List of detected vulnerabilities.</param>
    ...
    public static bool IsValidHasCriticalIssues(
        ...
        List<SqlInjectionIssue>? issues)
    {
        return ValidateHasCriticalIssues(detector, issues).Count == 0;
    }

    /// <summary>
    /// Ensures that the parameters for <see cref="SqlInjectionDetectorExtensions.FilterBySeverity(SqlInjectionDetector, List{SqlInjectionIssue}, string)"/>
    /// are valid, throwing an <see cref="ArgumentException"/> if not.
    /// </summary>
    /// <param name="detector">The detector instance.</param>
    /// <param name="issues">List of detected vulnerabilities.</param>
    /// <param name="minSeverity">Minimum severity level.</param>
    ...
    /// <summary>
    /// Ensures that the parameters for <see cref="SqlInjectionDetectorExtensions.GenerateDetailedReport(SqlInjectionDetector, List{SqlInjectionIssue}, string)"/>
    /// are valid, throwing an <see cref="ArgumentException"/> if not.
    /// </summary>
    /// <param name="detector">The detector instance.</param>
    /// <param name="issues">List of detected vulnerabilities.</param>
    ...
    /// <summary>
    /// Ensures that the parameters for <see cref="SqlInjectionDetectorExtensions.HasCriticalIssues(SqlInjectionDetector, List{SqlInjectionIssue})\"/>
    /// are valid, throwing an <see cref="ArgumentException"/> if not.
    /// </summary>
    /// <param name="detector">The detector instance.</param>
    /// <param name="issues">List of detected vulnerabilities.</param>
