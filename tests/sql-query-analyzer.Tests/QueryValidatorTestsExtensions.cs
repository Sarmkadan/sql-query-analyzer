...
{
    /// <summary>
    /// Extension methods that provide convenient wrappers around the public test members of
    ...
    public static class QueryValidatorTestsExtensions
    {
        ...
        /// instance.
        /// </summary>
        /// <param name="tests">The test class instance on which to invoke the checks.</param>
        ...
        /// <summary>
        /// Verifies that the sanitisation logic correctly truncates a query that exceeds the
