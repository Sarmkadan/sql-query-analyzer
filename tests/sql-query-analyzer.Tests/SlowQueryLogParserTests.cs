...
/// <summary>
/// Provides unit tests for the <see cref="SlowQueryLogParser"/> class.
/// Tests parsing functionality for MySQL and PostgreSQL slow query logs.
/// </summary>
public class SlowQueryLogParserTests
{
	/// <summary>
	/// System under test - instance of <see cref="SlowQueryLogParser"/> used for testing.
	/// </summary>
	private readonly SlowQueryLogParser _sut;

	/// <summary>
	/// Initializes a new instance of the <see cref="SlowQueryLogParserTests"/> class.
	/// </summary>
	...
	/// <summary>
	/// Tests parsing of MySQL slow query log entries.
	/// </summary>
	[Fact]
...
""";
	...
	/// <summary>
	/// Tests parsing of PostgreSQL slow query log entries.
	/// </summary>
	[Fact]
