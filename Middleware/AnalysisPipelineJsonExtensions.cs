...
public static class AnalysisPipelineJsonExtensions
{
	...
	public static string ToJson(this AnalysisPipeline value, bool indented = false)
	{
		...
		// indented parameter is a boolean and cannot be invalid
	...
	/// <returns>The deserialized analysis pipeline, or null if the JSON is invalid or deserialization fails.</returns>
